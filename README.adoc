...
image:https://img.shields.io/packagist/v/rich-id/terms-module-snappy-bundle[link="https://packagist.org/packages/rich-id/terms-module-snappy-bundle",window="_blank"]
image:https://github.com/rich-id/terms-module-snappy/workflows/Tests/badge.svg[link="https://github.com/rich-id/terms-module-snappy/actions",window="_blank"]
image:https://api.codeclimate.com/v1/badges/af5513a99208495d8c40/maintainability[link="https://codeclimate.com/github/rich-id/terms-module-snappy/maintainability",window="_blank"]
...
Snappy support to generate terms signature pdf.
...
[source,bash]
----
composer require rich-id/terms-module-snappy-bundle
----
